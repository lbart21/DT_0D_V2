...
class JoinedCombAndNozzleChokedOutlet():
    def __init__(self, TotalGeometry, prop1, prop2, \
                        propsGiven, Eilmer_fluid_file, CombHeatFlux, \
                        componentLabel, inletBC, combustorvel_x) -> None:
        """
        ...
        self.initialiseCell(Geometry = TotalGeometry, prop1 = prop1, \
                                ...
                                vel_x = combustorvel_x, componentLabel = componentLabel, \
                                fluidPairs = fluidPairs, heatFlux = CombHeatFlux)

        self.initialiseInterfaces(Geometry = TotalGeometry, fluidPairs = fluidPairs, inletBC = inletBC)
    ...
    def initialiseInterfaces(self, Geometry, fluidPairs, inletBC):
        [D_in, D_out, L_comb, L_noz] = Geometry
        ...
        OutInterface = NozzleOutletInterfaceChokedFlow(interface_ID = 1, fluidPair = fluidPairs)
