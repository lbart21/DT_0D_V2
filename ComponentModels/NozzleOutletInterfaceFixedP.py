...
class NozzleOutletInterfaceFixedP():
    def __init__(self, interface_ID, fluidPair, backPressure) -> None:
        ...
        self.interfaceState.fluid_state.p = backPressure
    ...
    def completeInterfaceMethods(self, cellArray, interfaceArray, mapCellIDToWestInterfaceIdx, \
        ...
        M_w = vel_x_w / WestCellState.fs.fluid_state.a
